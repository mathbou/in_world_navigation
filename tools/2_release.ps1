...
New-Item -Path "$ProjectRoot\build\r6\scripts" -ItemType "directory"
...
New-Item -Path "$ProjectRoot\build\red4ext\plugins\in_world_navigation" -ItemType "directory"
...
# Dist
New-Item -Path "$ProjectRoot\dist" -Type "Directory"
